<?php
    ...
    $schoolCharacterOutput .= '<div class="row">';
        $schoolCharacterOutput .= '<div class="col-md-12">';
            $schoolCharacterOutput .= '<h3>Economic Status</h3><p>' .   inject_data(get_field("enrollment_economic_status_description"), $schoolData, $schoolTypes) . '</p>';
        $schoolCharacterOutput .= '</div>';
    $schoolCharacterOutput .= '</div>';
    $schoolCharacterOutput .= '<div class="row">';
        $schoolCharacterOutput .= '<div class="col-md-12">';
        
            // START ECONOMIC STATUS

            $colorCount = 0;
            $enrollmentData = "";
            $enrollmentParams = [ 
                                    "EnrollmentEco_Disadvantaged"    => "Economically Disadvantaged", 
                                    "EnrollmentNon_Eco_Disadvantaged" => "Not Economically Disadvantaged"
                                ];

            $schoolCharacterOutput .= '<div id="exhibit-enrollment-status" class="exhibit-group">';
                $schoolCharacterOutput .= '<div id="school-enrollment-status" class="highchart pie-chart full-width-chart"></div>';
                                            ...
                                            (function($){
                                                ...
                                                $(document).ready(function () {
                                                    ...
                                                    if ( windowWidth > 767 ) {
                                                        ...
                                                        $("#school-enrollment-status").highcharts({
                                                            chart: {
                                                                type: "pie",
                                                                width: $("#exhibit-enrollment-status").width()
                                                            },
                                                            title: {
                                                                text: ""
                                                            },
